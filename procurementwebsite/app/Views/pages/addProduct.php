                            ...
                            <h6>
                                ...
                                <h6 class="text-dark">
                                    ...
                                    <div class="input_container">
                                        ...
                                        <input placeholder="PRODUCT NAME" name="name" type="text" class="input_field" id="name" value="" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea name="description" id="description" placeholder="Product Description*" rows="4" class="form-control" value="" required></textarea>
...
>>>>>>> 69e470b9953673e465ed2bc2a13554940f8b213c
                            <div class="media-body">
                                <label>
                                    ...
                                    <div class="input_container">
                                        ...
                                        <input placeholder="PRODUCT PRICE" name="price" type="number" class="input_field" id="price" value="" required>
                        ...
                        <div class="article-content">
                            ...
                            <div class="input_container">
                                <input placeholder="PRODUCT STATUS" name="status" type="text" class="input_field" id="status" value="" required></p>
