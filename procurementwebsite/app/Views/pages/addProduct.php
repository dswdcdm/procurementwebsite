                            ...
                            <h6>
                                ...
                                <h6 class="text-dark">
                                    ...
                                    <div class="input_container">
                                        ...
                                        <input placeholder="PRODUCT NAME" name="NAME" type="text" class="input_field" id="status" value="" required>
                                    </div>
                                </h6>
                            </h6>
                            <h6>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <textarea name="message" id="message" placeholder="Product Description*" rows="4" class="form-control" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </h6>
                                ...
                                <label>
                                    <h6>
                                        ...
                                        <div class="input_container">
                                            ...
                                            <input placeholder="PRODUCT PRICE" name="productprice" type="number" class="input_field" id="productprice" value="" required>
                        ...
                        <div class="article-content">
                            <h6 class>
                                ...
                                <div class="input_container">
                                    ...
                                    <input placeholder="PRODUCT STATUS" name="productstatus" type="text" class="input_field" id="productstatus" value="" required></p>
                                </div>
                            </h6>
                            </h6>
