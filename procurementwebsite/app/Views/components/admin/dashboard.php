              ...
              <tbody>
                <?php foreach ($users as $user) : ?>
                  ...
                  <tr>
                    ...
                    <td><span class ="d-flex gap-2 "><a href = "admin/ViewUser" class="action-button btn btn-primary text-light">view</a> <a href = "admin/UpdateUser"class="btn btn-success text-light">update </a></span>
